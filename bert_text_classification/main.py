...
def main():
    ...
    bert_config = AutoConfig.from_pretrained(args.pretrained_bert_dir, num_labels=config.num_labels)
    ...
    if args.mode == "train":
        ...
        # train
        train(model, config, train_iterator, dev_iterator, test_iterator)
